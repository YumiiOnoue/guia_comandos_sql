...
-- em um conjunto de linhas de resumo. Geralmente usado com funções 
-- de agregação.
SELECT categoria, 
...
-- LIMIT / TOP: Limita o número de registros retornados. 
-- (LIMIT é comum em MySQL, PostgreSQL, SQLite; TOP é comum em SQL Server).
